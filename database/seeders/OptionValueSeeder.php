...
class OptionValueSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $OptionValues = [
            ...
            [
                'category_seflink' => 'logistika',
                'option_title' => [
                    'Xidmətin növü' => [
                        'Çatdırılma və kuryer xidməti',
                        'Evakuator xidməti',
                        'Sürücü xidməti',
                        'Taksi xidməti',
                        'Yükdaşıma xidməti',
            ...
            [
                'category_seflink' => 'texnika-temiri',
                'option_title' => [
                    'Xidmətin növü' => [
                        'Audio və video cihazların təmiri',
                        'Kombi və su qızdırıcılarının təmiri',
                        'Kompyuter və noutbukların təmiri',
                        'Məişət texnikalarının təmiri',
                        'Musiqi alətlərinin təmiri',
                        'Oyun konsollarının təmiri',
                        'Printer təmiri və katric doldurulması',
                        'Telefon və planşetlərin təmiri',
                        'Televizorların təmiri',
                        'Tikinti və avadanlıqlarının təmiri',
                        'Digər',
                    ],
                ],
            ],
            [
                'category_seflink' => 'itler',
                'option_title' => [
                    'Cins' => [
                        'Akita-inu',
                        'Alabay',
            ...
            [
                'category_seflink' => 'geyim-ve-ayaqqabilar',
                'option_title' => [
                    'Cins' => [
                        'Qadın geyimləri',
                        'Kişi geyimləri',
            ...
            [
                'category_seflink' => 'noutbuklar-ve-netbuklar',
                'option_title' => [
                    'Marka' => [
                        'Acer',
                        'Apple Macbook',
